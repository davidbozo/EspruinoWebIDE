...
if (window.location.href.indexOf("lang=hu")>=0 ||
    window.location.href.indexOf("lang=")==-1) {
      ...
      /** @export */ Blockly.Msg.ADD_COMMENT = "Komment hozzáadása";
      ...
      /** @export */ Blockly.Msg.CHANGE_VALUE_TITLE = "Érték változtatása:";
      /** @export */ Blockly.Msg.CLEAN_UP = "Blockok törlése";
      /** @export */ Blockly.Msg.COLLAPSE_ALL = "Blockok összecsukása";
      /** @export */ Blockly.Msg.COLLAPSE_BLOCK = "Block összecsukása";
      ...
      /** @export */ Blockly.Msg.COLOUR_BLEND_TOOLTIP = "Két szín összekeverése adott aránnyal(0.0 - 1.0).";
      /** @export */ Blockly.Msg.COLOUR_PICKER_HELPURL = "https://en.wikipedia.org/wiki/Color";
      /** @export */ Blockly.Msg.COLOUR_PICKER_TOOLTIP = "Válassz egy színt a palettáról!";
      /** @export */ Blockly.Msg.COLOUR_RANDOM_HELPURL = "http://randomcolour.com";
      /** @export */ Blockly.Msg.COLOUR_RANDOM_TITLE = "Véletlenszerű szín";
      /** @export */ Blockly.Msg.COLOUR_RANDOM_TOOLTIP = "Véletlen szín választás.";
      ...
      /** @export */ Blockly.Msg.COLOUR_RGB_RED = "piros";
      /** @export */ Blockly.Msg.COLOUR_RGB_TITLE = "colour with";
      /** @export */ Blockly.Msg.COLOUR_RGB_TOOLTIP = "Szín készítése kék, zöld, piros színek megadásával. Az éertékek legynek 0 és 100 között.";
      /** @export */ Blockly.Msg.CONTROLS_FLOW_STATEMENTS_HELPURL = "https://github.com/google/blockly/wiki/Loops#loop-termination-blocks";
      /** @export */ Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_BREAK = "kilépés a ciklusból";
      /** @export */ Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE = "Folytassa a ciklust következő iterációjával";
      /** @export */ Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK = "Kilépés a folyamatos ciklusból.";
      /** @export */ Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE = "Ciklus hátralévő részének átugrása, folytatás a következő iterációval.";
      /** @export */ Blockly.Msg.CONTROLS_FLOW_STATEMENTS_WARNING = "Vigyáz: Ez a blokk csak a ciklusban használható.";
      /** @export */ Blockly.Msg.CONTROLS_FOREACH_HELPURL = "https://github.com/google/blockly/wiki/Loops#for-each";
      /** @export */ Blockly.Msg.CONTROLS_FOREACH_TITLE = "Minden %1 elem a(az) %2 listában";
      /** @export */ Blockly.Msg.CONTROLS_FOREACH_TOOLTIP = "Az összes elemnek a listábam, beállít '%1' változót az elemhez, és tegyen néhány kijelentést";
      /** @export */ Blockly.Msg.CONTROLS_FOR_HELPURL = "https://github.com/google/blockly/wiki/Loops#count-with";
      /** @export */ Blockly.Msg.CONTROLS_FOR_TITLE = " %1 számol   %2 -ig  %3 -től  %4 -esével";
      /** @export */ Blockly.Msg.CONTROLS_FOR_TOOLTIP = "A '%1' változó  felveszi az adott számot a kezdőértéktől az utólsó számig, adott intervallummal számolva, végrehajtva az adott blokkot.";
      /** @export */ Blockly.Msg.CONTROLS_IF_ELSEIF_TOOLTIP = "Feltétel hozzáadása az ha blokkhoz.";
      /** @export */ Blockly.Msg.CONTROLS_IF_ELSE_TOOLTIP = "végső és, összes elkapá kondíció hozzáadva a feltételes blokkhoz.";
      ...
      /** @export */ Blockly.Msg.CONTROLS_IF_MSG_ELSE = "ellenkezőleg";
      ...
      /** @export */ Blockly.Msg.CONTROLS_REPEAT_INPUT_DO = "csináld";
      /** @export */ Blockly.Msg.CONTROLS_REPEAT_TITLE = "ismételd meg %1 alkalommal";
